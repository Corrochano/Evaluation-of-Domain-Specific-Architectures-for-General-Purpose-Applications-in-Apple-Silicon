...
# Test to launch (exec)
python3 run_multigridjacobi.py $size 100 $number_exec fp16 cpu
...
echo " Running the jacobi model..."
# Test to launch (exec)
python3 run_multigridjacobi.py $size 100 $number_exec fp32 cpu
...
echo " Running the jacobi model..."
# Test to launch (exec)
python3 run_multigridjacobi.py $size 100 $number_exec fp16 gpu
...
echo " Running the jacobi model..."
# Test to launch (exec)
python3 run_multigridjacobi.py $size 100 $number_exec fp32 gpu
...
echo " Running the jacobi model..."
# Test to launch (exec)
python3 run_multigridjacobi.py $size 100 $number_exec fp16 ane
...
echo " Running the jacobi model..."
# Test to launch (exec)
python3 run_multigridjacobi.py $size 100 $number_exec fp32 ane
